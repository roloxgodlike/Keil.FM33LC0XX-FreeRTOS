...
/** @addtogroup FM33LC0xx_FL_Driver_WWDT
  * @{
  */
...
/**
  ...
  *       	-FAIL 未成功执行
  */
ErrorStatus FL_WWDT_DeInit(WWDT_Type* WWDTx)
{
...
/**
  ...
  * @param	WWDTx  外设入口地址
  *
  * @param 	FL_WWDT_InitTypeDef结构体，它包含指定WWDT外设的配置信息	  
  *         
  * @retval	ErrorStatus枚举值	
  *			-FAIL 配置过程发生错误        
  *			-PASS LPUART配置成功        
  */
ErrorStatus FL_WWDT_Init(WWDT_Type* WWDTx, FL_WWDT_InitTypeDef *WWDT_InitStruct)
{
