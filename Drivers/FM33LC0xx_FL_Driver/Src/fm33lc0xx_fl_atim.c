...
/** @addtogroup FM33LC0xx_FL_Driver_ATIM
  * @{
  */
...
#define IS_FL_ATIM_CC_MODE(__VALUE__)               (((__VALUE__) ==   FL_ATIM_CHANNEL_MODE_OUTPUT) \
                                                      || ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_TI1) \
                                                      || ((__VALUE__) == FL_ATIM_CHANNEL_MODE_INPUT_TI2) \
...
#define IS_FL_ATIM_AUTORELOAB_STATE(__VALUE__)          (((__VALUE__) == ENABLE) \
                                                    || ((__VALUE__) == DISABLE))
                                                    
#define IS_FL_ATIM_OC_FASTMODE(__VALUE__)          (((__VALUE__) == ENABLE) \
                                                    || ((__VALUE__) == DISABLE))

#define IS_FL_ATIM_OC_PRELOAD(__VALUE__)          (((__VALUE__) == ENABLE) \
                                                    || ((__VALUE__) == DISABLE))
                                                    
#define IS_FL_ATIM_OC_ETR_CLEARN(__VALUE__)        (((__VALUE__) == ENABLE) \
                                                    || ((__VALUE__) == DISABLE))

#define IS_FL_ATIM_OCN_STATE(__VALUE__)          (((__VALUE__) == ENABLE)\
                                                    || ((__VALUE__) == DISABLE))
...
#define IS_FL_ATIM_OC_NPOLARITY(__VALUE__)        (((__VALUE__) == FL_ATIM_OCN_POLARITY_NORMAL) \
                                                    || ((__VALUE__) == FL_ATIM_OCN_POLARITY_NORMAL))
...
#define IS_FL_ATIM_AUTOMATIC_OUTPUT_STATE(__VALUE__)    (((__VALUE__) == DISABLE) \
                                                        || ((__VALUE__) == ENABLE))

#define IS_FL_ATIM_TRIGGER_DELAY(__VALUE__)              (((__VALUE__) == DISABLE) \
                                                        || ((__VALUE__) == ENABLE))

#define IS_FL_ATIM_IC_CAPTURE_STATE(__VALUE__)           (((__VALUE__) == DISABLE) \
                                                        || ((__VALUE__) == ENABLE))
...
/** @defgroup TIM_FL_Private_Functions TIM Private Functions
  * @{
  */
static ErrorStatus  OCConfig(ATIM_Type *TIMx, uint32_t Channel, FL_ATIM_OC_InitTypeDef* TIM_OC_InitStruct );
/**
  * @}
  */
...
/**
  ...
  *       	-FAIL 未成功执行
  */
ErrorStatus FL_ATIM_DeInit(ATIM_Type *TIMx)
{
...
ErrorStatus FL_ATIM_Init(ATIM_Type *TIMx, FL_ATIM_InitTypeDef *TIM_InitStruct)
{
...
/**
  ...
  *			-PASS 成功  
  */ 
ErrorStatus FL_ATIM_SlaveMode_Init(ATIM_Type *TIMx, FL_ATIM_SlaveInitTypeDef *TIM_InitStruct)
{
...
/**
  ...
  *			-PASS 成功  
  */
ErrorStatus  FL_ATIM_IC_Init(ATIM_Type *TIMx,uint32_t channel,FL_ATIM_IC_InitTypeDef* IC_InitStruct)
{
    /* 参数检查 */
...
/**
  ...
  *			-PASS 成功  
  */
ErrorStatus  FL_ATIM_ETR_Init(ATIM_Type *TIMx, FL_ATIM_ETR_InitTypeDef* TIM_InitStruct)
{
    ...
    if(TIM_InitStruct->useExternalTrigger == ENABLE)
    {
...
{
    TIM_InitStruct->useExternalTrigger          = DISABLE;
...
/**
  ...
  *			-PASS 成功  
  */
ErrorStatus FL_ATIM_OC_Init(ATIM_Type *TIMx, uint32_t channel, FL_ATIM_OC_InitTypeDef *TIM_OC_InitStruct)
{
    ErrorStatus result = PASS;
    /* 参数检查 */
    assert_param(IS_ATIM_INSTANCE(TIMx)); 
...
/**
  ...
  *			-PASS 成功  
  */
ErrorStatus FL_ATIM_BDTR_Init(ATIM_Type *TIMx, FL_ATIM_BDTR_InitTypeDef *TIM_BDTR_InitStruct)
{
    ErrorStatus result = PASS;
    /* 参数检查 */
    assert_param(IS_ATIM_INSTANCE(TIMx));
