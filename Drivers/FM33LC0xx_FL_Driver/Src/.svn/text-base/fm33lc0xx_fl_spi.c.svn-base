...
/** @addtogroup FM33LC0xx_FL_Driver_SPI
  * @{
  */
...
/**
  ...
  *       	-FAIL 未成功执行
  */
ErrorStatus FL_SPI_DeInit(SPI_Type *SPIx)
{
...
/**
  ...
  *			-PASS LPUART配置成功  
  */
ErrorStatus FL_SPI_Init(SPI_Type *SPIx,FL_SPI_InitTypeDef *initStruct)
{
    ...
    /* 选择NSS脚控制模式 */
    if (initStruct->softControl == ENABLE)
    {
...
{
    initStruct->softControl         =   DISABLE;
