...
#define    GPIO_PINWKEN_SEL_Pos                                   (0U)
...
#define    FL_GPIO_WAKEUP_TRIGGER_RISING                          (0x0U << GPIO_PINWKEN_SEL_Pos)
#define    FL_GPIO_WAKEUP_TRIGGER_FALLING                         (0x1U << GPIO_PINWKEN_SEL_Pos)
...
{
    MODIFY_REG(GPIOx->PINWKEN, wakeup, (wakeup * mode));
}
...
/** @defgroup GPIO_FL_EF_Init Initialization and de-initialization functions
  * @{
  */
ErrorStatus FL_GPIO_Init(GPIO_Type *GPIOx, FL_GPIO_InitTypeDef *initStruct);
ErrorStatus FL_GPIO_DeInit(GPIO_Type *GPIOx, uint32_t pin);
void FL_GPIO_StructInit(FL_GPIO_InitTypeDef *initStruct);
ErrorStatus FL_WKUP_Init(FL_WKUP_InitTypeDef *initStruct, uint32_t wakeup);
ErrorStatus FL_WKUP_DeInit(uint32_t wakeup);
