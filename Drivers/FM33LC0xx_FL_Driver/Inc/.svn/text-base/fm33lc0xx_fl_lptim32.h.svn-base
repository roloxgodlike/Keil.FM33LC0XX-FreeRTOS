...
{
    return (uint32_t)(READ_BIT(LPTIM32x->CCR1, 0xffffffffU) >> 0U);
}
...
{
    return (uint32_t)(READ_BIT(LPTIM32x->CCR2, 0xffffffffU) >> 0U);
}
...
{
    return (uint32_t)(READ_BIT(LPTIM32x->ARR, 0xffffffffU) >> 0U);
}
...
{
    return (uint32_t)(READ_BIT(LPTIM32x->CNT, 0xffffffffU) >> 0U);
}
