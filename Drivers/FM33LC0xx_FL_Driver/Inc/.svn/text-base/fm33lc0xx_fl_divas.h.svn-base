...
{
    return (uint32_t)(READ_BIT(DIVx->END, 0xffffffffU) >> 0U);
}
...
{
    return (uint32_t)(READ_BIT(DIVx->SOR, 0xffffU) >> 0U);
}
...
{
    return (uint32_t)(READ_BIT(DIVx->QUOT, 0xffffffffU) >> 0U);
}
...
{
    return (uint32_t)(READ_BIT(DIVx->REMD, 0xffffU) >> 0U);
}
