...
#define    FL_RTC_BACKUP_0                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_1                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_2                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_3                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_4                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_5                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_6                                        (0x1U << 0U)
#define    FL_RTC_BACKUP_7                                        (0x1U << 0U)
...
{
    return (uint32_t)(READ_BIT(RTCx->SBSCNT, 0xffU) >> 0U);
}
