...
/**
  * @brief FL RCC Init Sturcture definition
  */
...
#define    FL_RCC_UART1_CLK_SOURCE_SYSCLK                         (0x3U << RCC_OPCCR1_UART1CKS_Pos)
#define    FL_RCC_UART1_CLK_SOURCE_RCMF_PSC                       (0x4U << RCC_OPCCR1_UART1CKS_Pos)
...
#define    FL_RCC_UART0_CLK_SOURCE_SYSCLK                         (0x3U << RCC_OPCCR1_UART0CKS_Pos)
#define    FL_RCC_UART0_CLK_SOURCE_RCMF_PSC                       (0x4U << RCC_OPCCR1_UART0CKS_Pos)
...
/**
  ...
  *           @arg @ref FL_RCC_PLL_MUL_32
  *           @arg @ref FL_RCC_PLL_MUL_48
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_PLL_WriteMultiplier(uint32_t multiplier)
{
    MODIFY_REG(RCC->PLLCR, RCC_PLLCR_DB_Msk, multiplier);
}
